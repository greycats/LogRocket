...
- (void)putStringArrayWithKey:(NSString * _Nonnull)key value:(NSArray<NSString *> * _Nonnull)value;
- (void)putDoubleWithKey:(NSString * _Nonnull)key value:(double)value;
- (void)putDoubleArrayWithKey:(NSString * _Nonnull)key value:(NSArray<NSNumber *> * _Nonnull)value;
- (void)putBoolWithKey:(NSString * _Nonnull)key value:(BOOL)value;
- (void)putBoolArrayWithKey:(NSString * _Nonnull)key value:(NSArray<NSNumber *> * _Nonnull)value;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
